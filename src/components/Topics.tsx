...
const topics: { text: string; top: number; left: number; ci: number; dur: number; dist: number }[] = [
  { text: "TDD",                     top: 5,   left: 25,  ci: 2, dur: 3.2, dist: 7  },
  { text: "Testing",                 top: 12,  left: 62,  ci: 0, dur: 4.0, dist: 5  },
  { text: "Diseño",                  top: 4,   left: 82,  ci: 3, dur: 3.6, dist: 8  },
  { text: "Patrones",                top: 30,  left: 8,   ci: 1, dur: 3.8, dist: 6  },
  { text: "Arquitectura",            top: 35,  left: 45,  ci: 3, dur: 4.2, dist: 9  },
  { text: "Clean Architecture",      top: 28,  left: 72,  ci: 0, dur: 3.4, dist: 7  },
  { text: "Hexagonal Architecture",  top: 58,  left: 18,  ci: 2, dur: 3.9, dist: 5  },
  { text: "MVC",                     top: 55,  left: 55,  ci: 1, dur: 3.1, dist: 8  },
  { text: "C#",                      top: 62,  left: 82,  ci: 0, dur: 4.4, dist: 6  },
  { text: "Unity",                   top: 82,  left: 35,  ci: 3, dur: 3.5, dist: 7  },
  { text: "Godot",                   top: 80,  left: 68,  ci: 2, dur: 3.7, dist: 9  },
];
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal delay={0.3}>
          <div className="relative mt-12 h-[280px] md:h-[240px]">
            {topics.map((topic, i) => {
              const color = palette[topic.ci];
              return (
                <motion.span
                  key={topic.text}
                  className="absolute px-3 py-1.5 md:px-4 md:py-2 text-xs md:text-sm font-bold text-white rounded-full whitespace-nowrap border border-white/30"
                  style={{
                    top: `${topic.top}%`,
                    left: `${topic.left}%`,
